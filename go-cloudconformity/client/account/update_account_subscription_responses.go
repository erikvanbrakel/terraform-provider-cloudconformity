...
func (o *UpdateAccountSubscriptionReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewUpdateAccountSubscriptionOK()
...
func NewUpdateAccountSubscriptionOK() *UpdateAccountSubscriptionOK {
	return &UpdateAccountSubscriptionOK{}
}
...
func (o *UpdateAccountSubscriptionOK) Error() string {
	return fmt.Sprintf("[PATCH /accounts/{id}/subscription][%d] updateAccountSubscriptionOK ", 200)
}

func (o *UpdateAccountSubscriptionOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
